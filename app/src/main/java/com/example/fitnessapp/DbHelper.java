...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void popolni() {
        ...
        if (!(c.getCount() > 0)) {
            ...
            cv.put("image","@drawable/side_plank");
            ...
            cv.put("image","@drawable/side_plank_hip_abduction");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/t_rotation");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/abdominal_bridge");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/boat_twist");
            db.insert("workouts", null, cv);
            ...
            cv.put("instructions", "1. Lie on the mat, place a resistance band around both legs and raise the legs toward the ceiling.\n" +
                    ...
                    "4. Repeat until the set is complete.");
            cv.put("image","@drawable/band_leg_abduction_crunch");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/basketball_shots");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/bicycle_crunches");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/band_reverse_plank");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/bent_leg_jackknife");
            db.insert("workouts", null, cv);
            ...
            cv.put("image","@drawable/balance_chop");
            db.insert("workouts", null, cv);
